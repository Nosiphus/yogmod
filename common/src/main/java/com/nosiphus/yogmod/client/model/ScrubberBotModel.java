package com.nosiphus.yogmod.client.model;
...
public class ScrubberBotModel<T extends Entity> extends HierarchicalModel<T> {
    public static final ModelLayerLocation SCRUBBER_BOT = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(YogMod.MOD_ID, "scrubber_bot"), "main");
    ...
    public ScrubberBotModel(ModelPart modelPart) {
        this.root = modelPart;
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.upperBody.yRot = netHeadYaw * ((float)Math.PI / 180F) * 0.25F;
