...
public class NCBConverter {
   ...
   static {
       ...
       CONVERSION_MAP.put(new BlockConversionKey("NosLabs:NosLabsHorizontalPipe", 0), new BlockConversionValue(ModBlock.PIPE, 0));
       CONVERSION_MAP.put(new BlockConversionKey("NosLabs:NosLabsHorizontalStripe", 0), new BlockConversionValue(ModBlock.STRIPE, 0));
