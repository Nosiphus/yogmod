...
public class PrimedDynamite extends Entity implements TraceableEntity {
    ...
    static {
        DATA_FUSE_ID = SynchedEntityData.defineId(PrimedDynamite.class, EntityDataSerializers.INT);
        DATA_BLOCK_STATE_ID = SynchedEntityData.defineId(PrimedDynamite.class, EntityDataSerializers.BLOCK_STATE);
