...
public class ModItems {
	...
	public static final RegistryObject<BlockItem> MAGENTA_PLASTIC = ITEMS.register("magenta_plastic", () -> new BlockItem(ModBlocks.MAGENTA_PLASTIC.get(), new Item.Properties().group(YogMod.YOGTAB)));
	public static final RegistryObject<BlockItem> LIGHT_BLUE_PLASTIC = ITEMS.register("light_blue_plastic", () -> new BlockItem(ModBlocks.LIGHT_BLUE_PLASTIC.get(), new Item.Properties().group(YogMod.YOGTAB)));
	...
	public static final RegistryObject<BlockItem> LIME_PLASTIC = ITEMS.register("lime_plastic", () -> new BlockItem(ModBlocks.LIME_PLASTIC.get(), new Item.Properties().group(YogMod.YOGTAB)));
	...
	public static final RegistryObject<BlockItem> GRAY_STUCCO = ITEMS.register("gray_stucco", () -> new BlockItem(ModBlocks.GRAY_STUCCO.get(), new Item.Properties().group(YogMod.YOGTAB)));
	public static final RegistryObject<BlockItem> LIGHT_GRAY_STUCCO = ITEMS.register("light_gray_stucco", () -> new BlockItem(ModBlocks.LIGHT_GRAY_STUCCO.get(), new Item.Properties().group(YogMod.YOGTAB)));
	...
	public static final RegistryObject<BlockItem> BROWN_STUCCO = ITEMS.register("brown_stucco", () -> new BlockItem(ModBlocks.BROWN_STUCCO.get(), new Item.Properties().group(YogMod.YOGTAB)));
	...
	public static final RegistryObject<BlockItem> IRON_PLATE_SLAB = ITEMS.register("iron_plate_slab", () -> new BlockItem(ModBlocks.IRON_PLATE_SLAB.get(), new Item.Properties().group(YogMod.YOGTAB)));
	...
	public static final RegistryObject<BlockItem> RAW_WOOD_SLAB = ITEMS.register("raw_wood_slab", () -> new BlockItem(ModBlocks.RAW_WOOD_SLAB.get(), new Item.Properties().group(YogMod.YOGTAB)));
	...
	public static final RegistryObject<BlockItem> IRON_PLATE_STAIRS = ITEMS.register("iron_plate_stairs", () -> new BlockItem(ModBlocks.IRON_PLATE_STAIRS.get(), new Item.Properties().group(YogMod.YOGTAB)));
	...
	public static final RegistryObject<BlockItem> IRON_PLATE_WALL = ITEMS.register("iron_plate_wall", () -> new BlockItem(ModBlocks.IRON_PLATE_WALL.get(), new Item.Properties().group(YogMod.YOGTAB)));
	...
	public static final RegistryObject<BlockItem> RAW_WOOD_WALL = ITEMS.register("raw_wood_wall", () -> new BlockItem(ModBlocks.RAW_WOOD_WALL.get(), new Item.Properties().group(YogMod.YOGTAB)));
	...
	public static final RegistryObject<BlockItem> BEIGE_PLASTIC_CARPET = ITEMS.register("beige_plastic_carpet", () -> new BlockItem(ModBlocks.BEIGE_PLASTIC_CARPET.get(), new Item.Properties().group(YogMod.YOGTAB)));
	public static final RegistryObject<BlockItem> WHITE_PLASTIC_CARPET = ITEMS.register("white_plastic_carpet", () -> new BlockItem(ModBlocks.WHITE_PLASTIC_CARPET.get(), new Item.Properties().group(YogMod.YOGTAB)));
	public static final RegistryObject<BlockItem> ORANGE_PLASTIC_CARPET = ITEMS.register("orange_plastic_carpet", () -> new BlockItem(ModBlocks.ORANGE_PLASTIC_CARPET.get(), new Item.Properties().group(YogMod.YOGTAB)));
	public static final RegistryObject<BlockItem> MAGENTA_PLASTIC_CARPET = ITEMS.register("magenta_plastic_carpet", () -> new BlockItem(ModBlocks.MAGENTA_PLASTIC_CARPET.get(), new Item.Properties().group(YogMod.YOGTAB)));
	public static final RegistryObject<BlockItem> LIGHT_BLUE_PLASTIC_CARPET = ITEMS.register("light_blue_plastic_carpet", () -> new BlockItem(ModBlocks.LIGHT_BLUE_PLASTIC_CARPET.get(), new Item.Properties().group(YogMod.YOGTAB)));
	public static final RegistryObject<BlockItem> GOLD_FILGAREE_CARPET = ITEMS.register("gold_filgaree_carpet", () -> new BlockItem(ModBlocks.GOLD_FILGAREE_CARPET.get(), new Item.Properties().group(YogMod.YOGTAB)));
	public static final RegistryObject<BlockItem> LIME_PLASTIC_CARPET = ITEMS.register("lime_plastic_carpet", () -> new BlockItem(ModBlocks.LIME_PLASTIC_CARPET.get(), new Item.Properties().group(YogMod.YOGTAB)));
	public static final RegistryObject<BlockItem> PINK_STUCCO_CARPET = ITEMS.register("pink_stucco_carpet", () -> new BlockItem(ModBlocks.PINK_STUCCO_CARPET.get(), new Item.Properties().group(YogMod.YOGTAB)));
	public static final RegistryObject<BlockItem> GRAY_STUCCO_CARPET = ITEMS.register("gray_stucco_carpet", () -> new BlockItem(ModBlocks.GRAY_STUCCO_CARPET.get(), new Item.Properties().group(YogMod.YOGTAB)));
	public static final RegistryObject<BlockItem> LIGHT_GRAY_STUCCO_CARPET = ITEMS.register("light_gray_stucco_carpet", () -> new BlockItem(ModBlocks.LIGHT_GRAY_STUCCO_CARPET.get(), new Item.Properties().group(YogMod.YOGTAB)));
    public static final RegistryObject<BlockItem> CYAN_PLASTIC_CARPET = ITEMS.register("cyan_plastic_carpet", () -> new BlockItem(ModBlocks.CYAN_PLASTIC_CARPET.get(), new Item.Properties().group(YogMod.YOGTAB)));
	public static final RegistryObject<BlockItem> VIOLET_VELVET_CARPET = ITEMS.register("violet_velvet_carpet", () -> new BlockItem(ModBlocks.VIOLET_VELVET_CARPET.get(), new Item.Properties().group(YogMod.YOGTAB)));
    public static final RegistryObject<BlockItem> BLUE_PLASTIC_CARPET = ITEMS.register("blue_plastic_carpet", () -> new BlockItem(ModBlocks.BLUE_PLASTIC_CARPET.get(), new Item.Properties().group(YogMod.YOGTAB)));
	public static final RegistryObject<BlockItem> BROWN_STUCCO_CARPET = ITEMS.register("brown_stucco_carpet", () -> new BlockItem(ModBlocks.BROWN_STUCCO_CARPET.get(), new Item.Properties().group(YogMod.YOGTAB)));
	public static final RegistryObject<BlockItem> GREEN_PLASTIC_CARPET = ITEMS.register("green_plastic_carpet", () -> new BlockItem(ModBlocks.GREEN_PLASTIC_CARPET.get(), new Item.Properties().group(YogMod.YOGTAB)));
    public static final RegistryObject<BlockItem> RED_PLASTIC_CARPET = ITEMS.register("red_plastic_carpet", () -> new BlockItem(ModBlocks.RED_PLASTIC_CARPET.get(), new Item.Properties().group(YogMod.YOGTAB)));
