package com.nosiphus.yogmod.tileentity;

import com.nosiphus.yogmod.init.ModTileEntityTypes;
...
public class CrateTileEntity extends LockableLootTileEntity implements IChestLid, ITickableTileEntity {
    ...
    public static void swapContents(CrateTileEntity chest, CrateTileEntity otherChest) {
